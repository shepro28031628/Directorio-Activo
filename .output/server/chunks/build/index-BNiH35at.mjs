...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-6" }, _attrs))}><div class="flex justify-between items-center flex-wrap gap-3"><div><h1 class="text-3xl font-bold tracking-tight text-slate-900 font-sans">Directorio de Colaboradores</h1><p class="text-slate-500">Gesti\xF3n de usuarios internos, proyectos y desvinculaciones centralizadas.</p></div><div class="flex gap-3 flex-wrap"><button${ssrIncludeBooleanAttr(unref(isSyncing)) ? " disabled" : ""} class="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-60 disabled:cursor-wait text-white font-semibold py-2 px-4 rounded-xl transition-all shadow-md shadow-blue-600/20 text-sm">`);
      if (!unref(isSyncing)) {
        _push(`<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg>`);
      } else {
      ...
      _push(` ${ssrInterpolate(unref(isSyncing) ? "Sincronizando..." : "Sincronizar con Jira")}</button><button class="bg-brand-purple hover:bg-brand-purpleHover text-white font-semibold py-2 px-4 rounded-xl transition-all shadow-md shadow-brand-purple/20 flex items-center gap-2"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg> Registrar Colaborador </button></div></div>`);
      if (unref(syncMessage)) {
        _push(`<div class="${ssrRenderClass([unref(syncMessage).startsWith("Error") ? "bg-red-50 text-red-700 border-red-200" : "bg-green-50 text-green-700 border-green-200", "px-4 py-3 rounded-xl text-sm font-medium border"])}">${ssrInterpolate(unref(syncMessage))}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="flex flex-col md:flex-row gap-4 bg-white/70 backdrop-blur-md p-4 rounded-2xl border border-brand-border shadow-sm"><div class="flex-grow"><input${ssrRenderAttr("value", unref(search))} type="text" placeholder="Buscar por colaborador, correo o proyecto..." class="w-full px-4 py-2 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-purple"></div><div class="w-full md:w-48"><select class="w-full px-4 py-2 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-purple bg-white"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(areaFilter)) ? ssrLooseContain(unref(areaFilter), "") : ssrLooseEqual(unref(areaFilter), "")) ? " selected" : ""}>Todas las \xC1reas</option><option value="Tecnolog\xEDa"${ssrIncludeBooleanAttr(Array.isArray(unref(areaFilter)) ? ssrLooseContain(unref(areaFilter), "Tecnolog\xEDa") : ssrLooseEqual(unref(areaFilter), "Tecnolog\xEDa")) ? " selected" : ""}>Tecnolog\xEDa</option><option value="Desarrollo"${ssrIncludeBooleanAttr(Array.isArray(unref(areaFilter)) ? ssrLooseContain(unref(areaFilter), "Desarrollo") : ssrLooseEqual(unref(areaFilter), "Desarrollo")) ? " selected" : ""}>Desarrollo</option><option value="Finanzas"${ssrIncludeBooleanAttr(Array.isArray(unref(areaFilter)) ? ssrLooseContain(unref(areaFilter), "Finanzas") : ssrLooseEqual(unref(areaFilter), "Finanzas")) ? " selected" : ""}>Finanzas</option><option value="Marketing"${ssrIncludeBooleanAttr(Array.isArray(unref(areaFilter)) ? ssrLooseContain(unref(areaFilter), "Marketing") : ssrLooseEqual(unref(areaFilter), "Marketing")) ? " selected" : ""}>Marketing</option><option value="Soporte"${ssrIncludeBooleanAttr(Array.isArray(unref(areaFilter)) ? ssrLooseContain(unref(areaFilter), "Soporte") : ssrLooseEqual(unref(areaFilter), "Soporte")) ? " selected" : ""}>Soporte</option></select></div><div class="w-full md:w-48"><select class="w-full px-4 py-2 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-purple bg-white"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(statusFilter)) ? ssrLooseContain(unref(statusFilter), "") : ssrLooseEqual(unref(statusFilter), "")) ? " selected" : ""}>Todos los Estados</option><option value="Activo"${ssrIncludeBooleanAttr(Array.isArray(unref(statusFilter)) ? ssrLooseContain(unref(statusFilter), "Activo") : ssrLooseEqual(unref(statusFilter), "Activo")) ? " selected" : ""}>Activo</option><option value="Vacaciones"${ssrIncludeBooleanAttr(Array.isArray(unref(statusFilter)) ? ssrLooseContain(unref(statusFilter), "Vacaciones") : ssrLooseEqual(unref(statusFilter), "Vacaciones")) ? " selected" : ""}>Vacaciones</option><option value="Suspendido"${ssrIncludeBooleanAttr(Array.isArray(unref(statusFilter)) ? ssrLooseContain(unref(statusFilter), "Suspendido") : ssrLooseEqual(unref(statusFilter), "Suspendido")) ? " selected" : ""}>Suspendido</option><option value="Retirado"${ssrIncludeBooleanAttr(Array.isArray(unref(statusFilter)) ? ssrLooseContain(unref(statusFilter), "Retirado") : ssrLooseEqual(unref(statusFilter), "Retirado")) ? " selected" : ""}>Retirado</option></select></div></div><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"><!--[-->`);
...
//# sourceMappingURL=index-BNiH35at.mjs.map
