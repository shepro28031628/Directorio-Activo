    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(pending)) {
        ...
        if (unref(col).equipos.length > 0) {
          ...
          _push(`<p class="text-xs text-slate-400 italic">Ningún hardware asociado.</p>`);
        }
        ...
        _push(`<!--]--></div>`);
        if (unref(isFinished)) {
          _push(`<div class="p-6 bg-gradient-to-r from-emerald-500/10 to-teal-500/10 rounded-2xl border border-emerald-500/20 text-center space-y-3"><div class="w-12 h-12 rounded-full bg-emerald-500 text-white flex items-center justify-center font-bold text-xl mx-auto shadow-lg shadow-emerald-500/20"> ✓ </div><h3 class="text-lg font-bold text-slate-800">Desvinculación Completada con Éxito</h3><p class="text-sm text-slate-600 max-w-md mx-auto"> El colaborador ha sido marcado como retirado en base de datos. Se suspendieron de manera segura todas las credenciales de Google Workspace y Microsoft 365, y se inhabilitó la pantalla de sus estaciones de trabajo. </p><div class="pt-4">`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: "/colaboradores",
...
//# sourceMappingURL=_id_-DTOj462m.js.map
