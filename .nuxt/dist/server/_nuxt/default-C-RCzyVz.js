import { defineComponent, ref, computed, useSSRContext, mergeProps, withCtx, openBlock, createBlock, createVNode, createTextVNode } from "vue";
import { ssrRenderTeleport, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrRenderSlot } from "vue/server-renderer";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              createTextVNode(" Políticas & GPOs ")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="w-4 h-4 shrink-0 text-[#8B949E] group-hover:text-[#58A6FF] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"${_scopeId}></path></svg> Bitácora Auditoría `);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                class: "w-4 h-4 shrink-0 text-[#8B949E] group-hover:text-[#58A6FF] transition-colors",
...
//# sourceMappingURL=default-C-RCzyVz.js.map
