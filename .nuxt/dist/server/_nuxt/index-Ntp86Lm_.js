import { _ as __nuxt_component_0 } from "./nuxt-link-CQE0urBr.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(colaboradores), (col) => {
        ...
        if (col.equipos?.length > 0) {
          ...
          _push(`<p class="text-slate-400 italic">Ningún activo tecnológico asignado.</p>`);
        }
        ...
        if (col.accesos?.filter((a) => a.estado === "Activo").length > 0) {
          _push(`<div class="flex flex-wrap gap-1.5"><!--[-->`);
        ...
        if (col.estado !== "Retirado") {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(` Iniciar Desvinculación `);
              } else {
                return [
                  createTextVNode(" Iniciar Desvinculación ")
                ];
              }
            }),
            _: 2
      ...
      if (unref(colaboradores).length === 0) {
        _push(`<div class="col-span-full text-center py-12 text-slate-400 text-sm"> No se encontraron colaboradores que coincidan con la búsqueda. </div>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=index-Ntp86Lm_.js.map
