...
import { _ as __nuxt_component_0$1 } from "./nuxt-link-CQE0urBr.js";
...
import { u as useRequestEvent, a as useFetch } from "./fetch-Cqko2rmb.js";
import { getRequestURL } from "D:/Documents/GitHub/Directorio-Activo/node_modules/h3/dist/index.mjs";
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(data)) {
        ...
        _push(`<!--]--></div><button class="w-full text-xs font-bold font-mono text-neon-cyan hover:underline flex items-center justify-between pt-2 border-t border-white/10"><span>Ficha Técnica Sci-Fi Inspector ➔</span></button></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="grid grid-cols-1 lg:grid-cols-3 gap-6"><div class="bento-card p-5 sm:p-6 lg:col-span-2 border-l-4 border-l-neon-cyan"><div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3"><div><h2 class="text-base sm:text-lg font-bold text-white flex items-center gap-2 font-mono"> ⚡ Despliegue Rápido de Agente MDM v2.0 </h2><p class="text-xs text-slate-400 mt-1">Copia y ejecuta en PowerShell como Administrador en Windows.</p></div>`);
...
//# sourceMappingURL=index-CVVRQBlC.js.map
