...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></tbody></table>`);
      if (unref(accesos)?.length === 0) {
        _push(`<div class="text-center py-12 text-slate-400 text-sm italic" data-v-b59e114e> Ningún permiso o acceso coincide con el filtro de búsqueda. </div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(`<!--]--></select></div><div data-v-b59e114e><label class="block text-[10px] font-extrabold text-violet-400 uppercase tracking-wider mb-2" data-v-b59e114e> Aplicación Corporativa </label><select class="w-full px-4 py-2.5 bg-slate-800 border border-slate-700 rounded-xl text-sm text-white focus:outline-none focus:border-violet-500 focus:ring-1 focus:ring-violet-500" data-v-b59e114e><option value="" data-v-b59e114e${ssrIncludeBooleanAttr(Array.isArray(selectedAplicacion.value) ? ssrLooseContain(selectedAplicacion.value, "") : ssrLooseEqual(selectedAplicacion.value, "")) ? " selected" : ""}>-- Seleccionar Aplicación --</option><!--[-->`);
...
//# sourceMappingURL=index-DRnH9Leq.js.map
