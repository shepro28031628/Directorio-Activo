...
import "./client-only-DhLfD2Bx.js";
const limit = 25;
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const equipos = computed(() => resultado.value?.data || []);
    const metaEquipos = computed(() => resultado.value?.meta || { total: 0, page: 1, limit, totalPages: 1 });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-6 relative overflow-hidden" }, _attrs))} data-v-f7df9d8e><div class="flex justify-between items-center flex-wrap gap-3" data-v-f7df9d8e><div data-v-f7df9d8e><h1 class="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white font-sans" data-v-f7df9d8e> Dispositivos Enrolados <span class="gradient-text-purple" data-v-f7df9d8e>MDM</span></h1><p class="text-slate-500 dark:text-slate-400 text-xs sm:text-sm mt-1" data-v-f7df9d8e>Supervisión en vivo, telemetría y administración remota de estaciones de trabajo.</p></div><div class="flex gap-3 flex-wrap" data-v-f7df9d8e><button${ssrIncludeBooleanAttr(isSyncing.value) ? " disabled" : ""} class="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-60 disabled:cursor-wait text-white font-semibold py-2 px-4 rounded-xl transition-all shadow-md shadow-blue-600/20 text-sm" data-v-f7df9d8e>`);
      if (!isSyncing.value) {
      ...
      if (drawerOpen.value && selectedEquipo.value) {
        ...
        _push(`</span><div data-v-f7df9d8e><h3 class="text-lg font-extrabold" data-v-f7df9d8e>${ssrInterpolate(selectedEquipo.value.hostname)}</h3><p class="text-xs text-slate-400" data-v-f7df9d8e>Consola Central de Operaciones del Dispositivo</p></div></div><button class="text-slate-400 hover:text-white transition" data-v-f7df9d8e><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-f7df9d8e><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-f7df9d8e></path></svg></button></div><div class="flex-grow p-6 space-y-6 overflow-y-auto" data-v-f7df9d8e><div class="grid grid-cols-2 gap-4" data-v-f7df9d8e><div class="bg-white p-4 rounded-2xl border border-slate-200/60 shadow-sm flex items-center justify-between" data-v-f7df9d8e><div data-v-f7df9d8e><span class="text-[10px] text-slate-400 font-bold uppercase tracking-wider block" data-v-f7df9d8e>Estado Conexión</span><span class="text-sm font-extrabold text-slate-800" data-v-f7df9d8e>${ssrInterpolate(selectedEquipo.value.estado)}</span></div><span class="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse inline-block" data-v-f7df9d8e></span></div><div class="bg-white p-4 rounded-2xl border border-slate-200/60 shadow-sm flex items-center justify-between" data-v-f7df9d8e><div data-v-f7df9d8e><span class="text-[10px] text-slate-400 font-bold uppercase tracking-wider block font-sans" data-v-f7df9d8e>Batería Remota</span><span class="text-sm font-extrabold text-slate-800" data-v-f7df9d8e>${ssrInterpolate(selectedEquipo.value.battery)}% (${ssrInterpolate(selectedEquipo.value.isCharging ? "Cargando" : "Descargando")})</span></div><span class="text-xs font-bold text-slate-400" data-v-f7df9d8e>${ssrInterpolate(selectedEquipo.value.batteryTemp)}°C</span></div></div><div class="bg-white p-5 rounded-2xl border border-slate-200/60 shadow-sm space-y-4" data-v-f7df9d8e><div class="flex justify-between items-center" data-v-f7df9d8e><h4 class="text-xs font-bold text-slate-400 uppercase tracking-wider" data-v-f7df9d8e>Telemetría en Vivo</h4>`);
        ...
        _push(`</div><div class="border-t border-slate-100 pt-4 space-y-2" data-v-f7df9d8e><label class="text-xs font-bold text-slate-600 block" data-v-f7df9d8e>Enviar Mensaje de Alerta Directo</label><div class="flex gap-2" data-v-f7df9d8e><input${ssrRenderAttr("value", alertMessage.value)} type="text" placeholder="Escribe la alerta que verá el usuario..." class="flex-grow px-3 py-1.5 border border-slate-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-brand-purple" data-v-f7df9d8e><button class="bg-brand-purple hover:bg-brand-purpleHover text-white px-4 py-1.5 rounded-xl text-xs font-bold transition shrink-0" data-v-f7df9d8e> Enviar Alerta </button></div></div><div class="border-t border-red-100 pt-4 bg-red-50/30 p-3.5 rounded-xl border border-dashed border-red-200/50 space-y-2" data-v-f7df9d8e><span class="text-xs font-extrabold text-red-600 block" data-v-f7df9d8e>Zona Crítica (Danger Zone)</span><p class="text-[10px] text-slate-500 leading-relaxed" data-v-f7df9d8e>Ejecuta el borrado completo de los datos del disco y desvincula el dispositivo del MDM para su retiro definitivo de la empresa.</p><button class="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-xl text-xs transition shadow-sm" data-v-f7df9d8e> Borrado Completo Remoto (Wipe Device) </button></div></div><div class="bg-slate-950 p-4 rounded-2xl shadow-inner space-y-3 font-mono text-slate-300" data-v-f7df9d8e><div class="flex justify-between items-center border-b border-slate-800 pb-2" data-v-f7df9d8e><span class="text-[10px] text-slate-500 font-bold" data-v-f7df9d8e>CONSOLA SHELL AGENTE</span><span class="text-[9px] text-brand-purple font-bold" data-v-f7df9d8e>SECURE CHANNEL</span></div><div class="text-[11px] leading-relaxed max-h-40 overflow-y-auto space-y-1.5 pr-2" data-v-f7df9d8e><!--[-->`);
...
//# sourceMappingURL=index-BEvsNwSG.js.map
