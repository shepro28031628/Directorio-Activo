...
import { $fetch } from "D:/Documents/GitHub/Directorio-Activo/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "D:/Documents/GitHub/Directorio-Activo/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "D:/Documents/GitHub/Directorio-Activo/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "D:/Documents/GitHub/Directorio-Activo/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu } from "D:/Documents/GitHub/Directorio-Activo/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol } from "D:/Documents/GitHub/Directorio-Activo/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CVVRQBlC.js")
  },
  {
    name: "google-admin",
    path: "/google/admin",
    component: () => import("./_nuxt/admin-NYn3k_HO.js")
  },
  {
    name: "anydesk",
    path: "/anydesk",
    component: () => import("./_nuxt/index-CgoOrYc8.js")
  },
  {
    name: "equipos",
    path: "/equipos",
    component: () => import("./_nuxt/index-BEvsNwSG.js")
  },
  {
    name: "microsoft-admin",
    path: "/microsoft/admin",
    component: () => import("./_nuxt/admin-DfNg_djC.js")
  },
  {
    name: "politicas",
    path: "/politicas",
    component: () => import("./_nuxt/index-BJ242Bup.js")
  },
  {
    name: "auditorias",
    path: "/auditorias",
    component: () => import("./_nuxt/index-CubIA3wU.js")
  },
  {
    name: "aplicaciones",
    path: "/aplicaciones",
    component: () => import("./_nuxt/index-DRnH9Leq.js")
  },
  {
    name: "enrolamiento",
    path: "/enrolamiento",
    component: () => import("./_nuxt/index-BMuEPlnN.js")
  },
  {
    name: "colaboradores",
    path: "/colaboradores",
    component: () => import("./_nuxt/index-Ntp86Lm_.js")
  },
  {
    name: "active-directory",
    path: "/active-directory",
    component: () => import("./_nuxt/index-CLlDGMz9.js")
  },
  {
    name: "desvinculacion-wizard-id",
    path: "/desvinculacion/wizard/:id()",
    component: () => import("./_nuxt/_id_-DTOj462m.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-C-RCzyVz.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CVikYkhN.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DZKTZeZf.js"));
