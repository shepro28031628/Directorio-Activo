...
const _lazy_RU1rOb = () => Promise.resolve().then(function () { return version_get$1; });
        ...
        children: [
          {
            ...
            children: [
              ...
              { id: "ou-bog-hr", name: "Gesti\xF3n Humana", dn: "OU=RRHH,OU=Sede Bogota,OU=REN Corporativo,DC=ren,DC=local", type: "Department", count: 150 }
            ]
          },
          {
            id: "ou-medellin",
            ...
            count: 120,
            children: [
              { id: "ou-med-ops", name: "Operaciones Medell\xEDn", dn: "OU=Operaciones,OU=Sede Medellin,OU=REN Corporativo,DC=ren,DC=local", type: "Department", count: 120 }
            ]
          },
          {
            id: "ou-devices",
