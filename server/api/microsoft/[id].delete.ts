...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    // Eliminar en Microsoft Azure AD API Real
    ...
    await prisma.auditoria.create({
      data: {
        ...
        detalles: `Eliminado permanentemente el usuario ${existing.nombre} (${existing.correo}) de Microsoft 365 (Azure AD). Realizado vía API: ${apiSuccess ? 'Sí' : 'Simulada'}.`,
